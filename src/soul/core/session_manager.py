# Migrated from runtime/session_manager.py — kept backward-compatible.
# Now delegates to the same persistence pattern.
...
class SessionManager:
    """File-based per-session SoulState persistence."""
